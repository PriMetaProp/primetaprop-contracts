...
contract AdminUpgradeabilityProxy is UpgradeabilityProxy {
     ...
     * This is the keccak-256 hash of "sparkle.17032022.proxy.admin", and is validated in the constructor.
     */
    bytes32 private constant ADMIN_SLOT = 0xfc0b65762da209948f037e17775f05cbbb045862a8e86b8106c2335590891208;
    /**
    ...
    constructor(address _implementation) UpgradeabilityProxy(_implementation) public {
        assert(ADMIN_SLOT == keccak256("sparkle.17032022.proxy.admin"));
